    ...
    <v-row>
      ...
      <v-col cols="12" md="4">
        <v-card class="pa-3" rounded="lg">
          ...
          >
            <v-list-item-group>
              <ConfirmEventItem v-for="event in getTodayNotConfirmedEvents" :key="event.id" :event="event" />
            </v-list-item-group>
          </v-list>
...
export default {
  ...
  computed: {
    ...mapGetters(["getAllEvents", "getSalon", "getUserData", 'getTodayNotConfirmedEvents']),
    cal() {
